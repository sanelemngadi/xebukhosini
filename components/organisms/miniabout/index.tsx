...
const MiniAbout = () => {
    ...
    return (
        <div className={styles.miniAboutBox}>
            <section className={styles.miniAboutContainer}>
                <article>
                    <Image src='/images/xeImage.jpg' layout='fill' objectFit='cover' alt="your next social worker mr X E Bukhosini" />
                </article>
                <article>
                    <h2>A registered and accredited social worker with over 14  years of experience.</h2>
